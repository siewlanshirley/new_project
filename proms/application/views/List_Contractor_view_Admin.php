...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
             ...
             <li><a href="<?php echo site_url('ProjectController/listprojectviewAdmin');?>"><i class="fa fa-circle-o"></i>List of Projects</a>
       </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php $ContractorController = $this->Contractor_Model->getAllContractorsAdmin();?>
        ...
        <?php foreach($ContractorController as $p): ?>
                <tr>
                  ...
                  <td><a href="<?php echo site_url("ContractorController/view_contractor_admin/{$p['con_id']}") ?>" ><?php echo $p['con_name']; ?></td>
           ...
           <td> <a href="<?php echo site_url("ContractorController/update_contractor_view_admin/{$p['con_id']}") ?>" onClick="return confirm('Are you sure to update this records?') ;"?>
       <button type="submit" class="btn btn-primary" name="update"> Update </button></a>
     </td>


       <td> <a href="<?php echo site_url("ContractorController/delete_contractor_view/{$p['con_id']}") ?>" onClick="return confirm('Are you sure to update this records?') ;"?>
       <button type="submit" class="btn btn-danger" name="update"> Delete</button></a>
     </td>
