...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>PROMS KkLW</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PROMS KkLW</b></span>
    </a>
    ...
    <section class="content">
      ...
      <?php foreach($detail as $s): ?>
        ...
        <tr><div class="form-group">
                  <td align="center"><label for="name">Title</label> 
                  <label></td> <td align="center"><b>Details</b></label></td>
                 
                </div></tr>

        <tr><div class="form-group">
                  <td><label for="name">Staff ID</label> <label></td> <td align="center"> <?php echo $s['id']; ?> </label></td>
                </div></tr>

          <tr><div class="form-group">
                  <td><label for="name">Name</label> <label></td> <td align="center"> <?php echo $s['name']; ?> </label></td>
                </div></tr>
        
        <tr><div class="form-group">
                  <td><label for="name">Grade</label> <label></td> <td align="center"> <?php echo $s['grade']; ?> </label></td>
                </div></tr>
        
      
          <tr><div class="form-group">
                  <td><label for="name">Email</label> <label></td> <td align="center"> <?php echo $s['email']; ?> </label></td>
                </div></tr>
        

          <tr><div class="form-group">
                  <td><label for="name">Contact Number</label> <label></td> <td align="center"> <?php echo $s['phone']; ?> </label></td>
                </div></tr>
