...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
       <li><a href="<?php echo site_url('ContractorController/listcontractorview');?>"><i class="fa fa-circle-o"></i> List Of Contractors</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
           ...
           <?php $a = $this->session->userdata('username');
               $ProjectController = $this->Project_Model->getAllProjects($a);?>
        ...
        <?php foreach($ProjectController as $p): ?>
                <tr>
                  ...
                  <td><a href="<?php echo site_url("ProjectController/view_project/{$p['pro_id']}") ?>" ><?php echo $p['pro_name']; ?></a></td>
                  

          
       <td> <a href="<?php echo site_url("ProjectController/update_project_view/{$p['pro_id']}") ?>" onClick="return confirm('Are you sure to update this records?') ;"?>
