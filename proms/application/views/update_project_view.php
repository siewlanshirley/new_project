 ...
 <!-- form start -->
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="begin_date" placeholder="Project Start Date" value="<?php echo $z -> begin_date; ?>"required> 
                </div>
        
       <div class="form-group">
                  <label for="end_date">Project End Date</label>
                  <input type="date" class="form-control" name="end_date" placeholder="Expected Finishing Date " value="<?php echo $z -> end_date; ?>" read only> 
                </div>


         <div class="form-group">               
                  <label for="cost">Cost</label>
                  <input type="text" class="form-control" id="cost" name="cost" placeholder="(RM)" value="<?php echo $z -> cost; ?>"required >
                </div>  
         ...
         <div class="form-group">
                  ...
                  <input type="textarea" class="form-control" rows="3" id="description" name="description" placeholder="Enter ..." value="<?php echo $z -> description; ?>"required>
                </div>
