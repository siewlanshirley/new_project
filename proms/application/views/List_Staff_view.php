      ...
      <div class="row">
        <div class="col-xs-20">
          ...
          <div class="box">
            ...
            <?php $a = $this->session->userdata('username');
                 $LoginController = $this->Login_Model->getAllStaffs($a);?>
        ...
        <?php foreach($LoginController as $p): ?>
                <tr>
                  ...
                  <td><a href="<?php echo site_url("LoginController/view_staff/{$p['id']}") ?>" ><?php echo $p['name']; ?></td>
                 


          
       <td> <a href="<?php echo site_url("LoginController/update_staff_view/{$p['id']}") ?>" onClick="return confirm('Are you sure to update this records?') ;"?>
