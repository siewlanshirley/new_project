  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
       <li><a href="<?php echo site_url('ProjectController/List_Project_view');?>"><i class="fa fa-circle-o"></i> List Of The Project</a></li>
...
<form  method="post" action="<?php echo site_url('ProjectController/updateProjectController');?>">
  ...
  <!-- Main content -->
    ...
    <section class="content">
      ...
      $MilestonesController = $this->Milestones_Model->viewProgressModel($p);?>
      <?php foreach ($MilestonesController as $z):?> 
 ...
 <!-- form start -->
          ...
          <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pro_name" name="pro_name" placeholder="Name Of Project" value="<?php echo $z['pro_name']; ?>" readonly/>
                </div>
         ...
         <?php $MilestonesController = $this->Milestones_Model->get_one_project($p);
      foreach ($MilestonesController as $z):?> 


         <div class="form-group">
                  <label for="description">Progress</label>
                  <input type="text" class="form-control" rows="3" placeholder="Enter ..." value="<?php 
                  echo $z -> weight; ?>"required >
                </div>
