...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
     ...
     <li class="treeview">
      ...
      <ul class="treeview-menu">
       <li><a href="<?php echo site_url('LoginController/list_user_view_admin');?>"><i class="fa fa-circle-o"></i> Registered User</a></li>
       <li><a href="<?php echo site_url('LoginController/list_user_view_a');?>"><i class="fa fa-circle-o"></i> Update Profile</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center>Projects Milestones</center>
      
      </h1>
      <ol class="breadcrumb">
         <li class="active"> Milestones NewsFeed</a></li>
        ...
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li>
               ...
               $MilestonesController = $this->Milestones_Model->getAllProjectsAdmin();?>
                       ...
                       <div class="timeline-body">
                        ...
                        <div class="progress progress-xs progress-striped active">
                         ...
                         <div class="timeline-footer">
                              ...
                              <a href="<?php echo site_url("MilestonesController/view_comment/{$c['pro_id']}") ?>"?>
                              <button type="submit" class="btn btn-primary" name="view" align="right">Comment</button></a>
