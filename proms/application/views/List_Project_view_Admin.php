...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
             ...
             <li><a href="<?php echo site_url('MilestonesController/listmilestonesviewAdmin');?>"><i class="fa fa-circle-o"></i> Project Progression</a></li>
    </ul>
    </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php $ProjectController = $this->Project_Model->listProjectModel();?>
          ...
          <th>delete</th>
                ...
                <tbody>
        <?php foreach($ProjectController as $p): ?>
                <tr>
                 
                  <td><a href="<?php echo site_url("ProjectController/view_project_admin/{$p['pro_id']}") ?>" ><?php echo $p['pro_name']; ?></a></td>
                  

          
       <td> <a href="<?php echo site_url("ProjectController/update_project_view_admin/{$p['pro_id']}") ?>" onClick="return confirm('Are you sure to update this records?') ;"?>
       <button type="submit" class="btn btn-primary" name="update" align="right"> Update</button></a>
     </td>
     ...
     <td> <a href="<?php echo site_url("ProjectController/delete_project_view/{$p['pro_id']}") ?>" >
