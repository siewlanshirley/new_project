...
class LoginController extends CI_Controller {
	...
	public function list_user_view_a()

	{
	 $this->load->view('List_Staff_view_a');
	}
  	...
  	public function addauser()
      {
       ...
       // create data
		...
		public function update_staff_view($id)
			...
			public function update_staff_view_a($id)

			{
				$data ['s'] = $id;
				$this->load->view('update_staff_view_a',$data);
			}
			...
			public function updateStaffControllerAdmin()

			{
				...
				if($result==true)

		           {
			               ...
			               echo '<script>alert("You Have Successfully Updated Your Profile!");</script>';
			               redirect('LoginController/list_user_view_a', 'refresh');
           			...
           			{
			               echo '<script>alert("Failed To Update Your Profile!");</script>';
			               redirect('LoginController/update_staff_view_a', 'refresh');
           			}
