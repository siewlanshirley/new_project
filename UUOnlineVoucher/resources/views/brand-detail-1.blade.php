...
<div class="container-page">
    <div class="mp-pusher" id="mp-pusher">
        ...
        <div class="top-area">
            <div class="top-of-brand">
                <img class="brand-img" style="background-image: url('images/ex/07-01.jpg');" src="images/null.gif" alt="Lindt"/>
                <div class="grid_frame">
                    <div class="container_grid clearfix">
                        <div class="grid_12">
